...
const AppSidebar = () => {
  ...
  return (
    <aside
      className="fixed left-0 z-50 flex flex-col justify-between w-12 px-1 py-4 ml-1 overflow-hidden transition-all duration-100 ease-in-out bg-yellow-500 top-2 bottom-2 rounded-xl hover:w-64"
