...
const buttonVariants = cva(
  "inline-flex items-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-gn-500 text-primary-foreground shadow hover:bg-gn-400",
        secondary:
          "bg-white text-gn-500 shadow-sm hover:bg-gn-50 outline-gn-500 outline",
        destructive:
          "bg-destructive text-destructive-foreground shadow-sm hover:bg-destructive/90",
        outline:
          "border border-input bg-background shadow-sm hover:bg-accent hover:text-accent-foreground",

        ghost: "hover:bg-gableGreen-400 text-primary-foreground",
        ghostleft: "hover:bg-accent hover:text-accent-foreground",
...
const ButtonSidebar = React.forwardRef(
